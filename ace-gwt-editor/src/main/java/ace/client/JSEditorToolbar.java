 ...
 * functionality.
 */
public class JSEditorToolbar extends Composite {
  ...
  public interface Images extends ClientBundle {
    ...
    @Source("ace/public/images/indent.gif")    
    ImageResource indent();

    @Source("ace/public/images/outdent.gif")
    ImageResource outdent();

    @Source("ace/public/images/save.png")
    ImageResource save();
  ...
  public interface Strings extends Constants {
    ...
    @DefaultStringValue("save content")
    String save();
  }
...
*/      
    ...
    public void onClick(ClickEvent event) {
      ...
      if( sender == save ) {
    	fireSaveEvent( new JSEditorSaveEvent(editor) );  
      } 
/*
      if (sender == bold) {
        basic.toggleBold();
...
*/      
  ...
  private final JSEditorProxy editor;
  ...
  public JSEditorToolbar(JSEditorProxy editor ) {
    ...
    topPanel.add( new Label("JSEditor") {{ 	setWidth("70px"); }} );
    
    topPanel.add(save = createPushButton(images.save(), strings.save()));    
    topPanel.add(indent = createPushButton(images.indent(), strings.indent())); indent.setEnabled(false);
    topPanel.add(outdent = createPushButton(images.outdent(), strings.outdent()));outdent.setEnabled(false);
...
*/    
  ...
  public void addHandler( JSEditorHandler h  ) {
	  ...
	  hm.addHandler( JSEditorSaveEvent.getType(), h);
	  
  }
 
  public void removeHandler( JSEditorHandler h  ) {
	  
	  hm.removeHandler( JSEditorSaveEvent.getType(), h);
	  
  }
  
  protected void fireSaveEvent( JSEditorSaveEvent e ) {
	  hm.fireEvent(e);
  }
